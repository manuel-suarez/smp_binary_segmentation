...
class PetModel(pl.LightningModule):
    def __init__(self, arch, encoder_name, in_channels, out_classes, **kwargs):
        ...
        # for image segmentation dice loss could be the best firs choice
    ...
    def shared_step(self, batch, stage):
        ...
        # if you work with grayscale images, expand channels to dim to have [batch_size, 1, height, width]
        assert image.ndim == 4
